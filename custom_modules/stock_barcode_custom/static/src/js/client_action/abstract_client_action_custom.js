odoo.define('stock_barcode_custom.ClientAction_custom', function (require) {
'use strict';
...
var HeaderWidget = require('stock_barcode_custom.HeaderWidgetCustom');
var LinesWidget = require('stock_barcode_custom.LinesWidgetCustom');
...
core.action_registry.add('stock_barcode_client_action_custom', ClientAction);
