odoo.define('stock_barcode_custom.picking_client_action_custom', function (require) {
'use strict';
...
core.action_registry.add('stock_barcode_picking_client_action_custom', PickingClientAction);
